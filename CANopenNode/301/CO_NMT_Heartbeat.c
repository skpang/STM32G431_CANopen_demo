    ...
    if (NMT->internalCommand != CO_NMT_NO_COMMAND) {
        switch (NMT->internalCommand) {
            case CO_NMT_ENTER_OPERATIONAL:
                ...
                log_printf("CO_NMT_ENTER_OPERATIONAL\n");
                break;
            case CO_NMT_ENTER_STOPPED:
                NMTstateCpy = CO_NMT_STOPPED;
                log_printf("CO_NMT_ENTER_STOPPED\n");
                break;
            case CO_NMT_ENTER_PRE_OPERATIONAL:
                NMTstateCpy = CO_NMT_PRE_OPERATIONAL;
                log_printf("CO_NMT_ENTER_PRE_OPERATIONAL\n");
                break;
            case CO_NMT_RESET_NODE:
                resetCommand = CO_RESET_APP;
                log_printf("CO_NMT_RESET_NODE\n");
                break;
            case CO_NMT_RESET_COMMUNICATION:
                resetCommand = CO_RESET_COMM;
                log_printf("CO_NMT_RESET_COMMUNICATION\n");
                break;
            default:
                break;
        }
