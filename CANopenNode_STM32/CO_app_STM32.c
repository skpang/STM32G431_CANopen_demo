...
canopen_app_process() {
   ...
   //     LL_GPIO_SetOutputPin(LED1_GPIO_Port, LED1_Pin);
    //    LL_GPIO_ResetOutputPin(LED1_GPIO_Port, LED1_Pin);
       // LL_GPIO_IsOutputPinSet `LL_GPIO_IsOutputPinSet'
        /* LEDs are active low */

              if (!LED_red_status && LL_GPIO_IsOutputPinSet(LED1_GPIO_Port, LED1_Pin)) {
                  LL_GPIO_ResetOutputPin(LED1_GPIO_Port, LED1_Pin);
              } else if (LED_red_status && !LL_GPIO_IsOutputPinSet(LED1_GPIO_Port, LED1_Pin)) {
                  LL_GPIO_SetOutputPin(LED1_GPIO_Port, LED1_Pin);
              }


              if (!LED_green_status && LL_GPIO_IsOutputPinSet(LED2_GPIO_Port, LED2_Pin)) {
                  LL_GPIO_ResetOutputPin(LED2_GPIO_Port, LED2_Pin);
              } else if (LED_green_status && !LL_GPIO_IsOutputPinSet(LED2_GPIO_Port, LED2_Pin)) {
