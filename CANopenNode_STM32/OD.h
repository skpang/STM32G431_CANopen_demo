...
********************************************************************************
    ...
    File info:
        ...
        Project File: STM32G431_Nucleo_shield_CANopen_demo.xpd
        File Version: 1

        Created:      23/11/2020 12:00:00
        Created By:   
        Modified:     21/07/2023 19:57:38
        Modified By:  

    Device Info:
        Vendor Name:  04
        Vendor ID:    08
        Product Name: STM32G431 Nucleo Shield
        Product ID:   0001
...
#define OD_ENTRY_H6200 &OD->list[22]
#define OD_ENTRY_H6401 &OD->list[23]
...
#define OD_ENTRY_H6000_readInput8Bit &OD->list[21]
#define OD_ENTRY_H6200_writeOutput8Bit &OD->list[22]
#define OD_ENTRY_H6401_readAnalogueInput16Bit &OD->list[23]
